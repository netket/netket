...
"""
Pseudo-inverse Solver for SR

Demonstrates robust SR optimization using pseudo-inverse solver for QGT.

Tags: ising, sr, pseudo_inverse
"""
...
gs = nkx.driver.VMC_SR(ha, op, variational_state=vs, linear_solver_fn=partial(nk.optimizer.solver.pinv, rtol=1.0e-6), diag_shift=0.01)
