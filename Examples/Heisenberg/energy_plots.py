"""
Energy plotting for Heisenberg J1-J2 model results.

Visualizes ground state and excited state energy convergence.

Tags: heisenberg, plotting, analysis, visualization
"""
