...
gs.run(
    n_iter=30,
    out=(
        nk.logging.SaveVariationalState(path="ising_example/", interval=10),
        nk.logging.JsonLog("ising_example/observables.log"),
    ),
    timeit=True,
)

vs_10 = nqxpack.load("ising_example/state_00010.nk")
