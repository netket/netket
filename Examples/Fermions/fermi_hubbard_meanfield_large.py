...
charge_density = charge_density.reshape(Ly, Lx)
spin_density = spin_density.reshape(Ly, Lx)
...
im2 = ax2.imshow(charge_density, cmap="RdBu", origin="lower", aspect="equal")
ax2.set_xlabel("x")
ax2.set_ylabel("y")
...
im3 = ax3.imshow(spin_density, cmap="RdBu", origin="lower", aspect="equal")
ax3.set_xlabel("x")
ax3.set_ylabel("y")
