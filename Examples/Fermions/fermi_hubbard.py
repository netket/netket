...
ham_hopping_of = openfermion.hamiltonians.fermi_hubbard(
    L, L, 1, 0, periodic=True, spinless=True
)

# create a hilbert at half filling
hi = nk.hilbert.LatticeFermions2nd(Nsites, n_fermions=Nf)
