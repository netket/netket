...
* The `Grid` API has been retired in favour of specialised `Lattice` constructors. For the time being, this removes the `color_edges` constructor switch and the automatic construction of the point group for the time being. [#724](https://github.com/netket/netket/pull/724)
