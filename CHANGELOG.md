...
### Bug Fixes
* The progress bar of `driver.run` now shows the right progress when a callback changes the step count in `on_run_start` (for example when resuming from a checkpoint), instead of ending before the end of the bar [PR #2288](https://github.com/netket/netket/pull/2288).
