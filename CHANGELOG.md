...
* The `little_group` and `space_group_irreps` methods of `SpaceGroupBuilder` take their arguments as varargs rather than iterables. [#975](https://github.com/netket/netket/pull/975)
