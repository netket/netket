...
class DenseEquivariant(Module):
    ...
    group_algebra: HashableArray
    """Flattened array generated  SymmGroup.group_algebra() that specifies the mapping
    ...
    def setup(self):
        self.n_symm = int(np.sqrt(np.array(self.group_algebra).shape[0]))
