...
class DenseEquivariant(Module):
    ...
    flattened_Cayley: HashableArray
    """Flattened cayley table generated by SymmGroup.flattened_Cayley()
    ...
    def setup(self):
        self.n_symm = int(np.sqrt(np.array(self.flattened_Cayley).shape[0]))
    ...
    def full_kernel(self, kernel):
        ...
        result = jnp.take(kernel, self.flattened_Cayley, 0)
