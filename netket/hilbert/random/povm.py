...
from netket.hilbert.povm import AbstractPOVM
from netket.utils.dispatch import dispatch


@dispatch
def random_state(hilb: AbstractPOVM, key, batches: int, *, dtype):
...
@dispatch
def flip_state_scalar(hilb: AbstractPOVM, key, σ, indx):
...
@dispatch
def flip_state_batch(hilb: AbstractPOVM, key, σ, indxs):
    n_batches = σ.shape[0]
