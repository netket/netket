...
class MCState(VariationalState):
    ...
    def expect_and_grad(
        ...
        **kwargs,
        ...
        return expect_and_grad(
            ...
            mutable=mutable,
            **kwargs,
            self, Ô, use_covariance, self.chunk_size, self.grad_chunk_size, mutable=mutable
        )
    ...
    def expect_and_forces(
        ...
        *,
        ...
        return expect_and_forces(self, Ô, self.chunk_size, self.grad_chunk_size, mutable=mutable)
