    ...
    * and the space group that is generated as their semidirect product.
    ...
    def _translations_along_axis(self, axis: int) -> PermutationGroup:
        ...
        if self.lattice._pbc[axis]:
            ...
            for i in range(1, self.lattice.extent[axis]):
    ...
    def _little_group_irreps(self, k: Array, divide: bool = False) -> Array:
        """
        Returns the character table of the little group embedded in the full point group.
        Symmetries outside the little group get 0.
    ...
    def space_group_irreps(self, k: Array) -> Array:
        ...
        Returns:
            An array `CT` listing the characters for a number of irreps of the space group.
