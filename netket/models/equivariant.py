...
class GCNN(nn.Module):
    ...
    group_algebra: Optional[HashableArray] = None
    """A flattened array generated by SymmGroup.group_algebra() representing the mapping between
     relative and absolute poses. Does not need to be specified if symmetries is a SymmGroup.
    """
