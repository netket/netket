...
void AddUnsupervisedModule(py::module &m) {
  ...
  py::class_<QuantumStateReconstruction>(subm, "Qsr")
      .def(py::init<SamplerType &, AbstractOptimizer &, int, int, int,
                    std::vector<MatType>, std::vector<std::vector<int> >,
                    std::vector<Eigen::VectorXd>, std::vector<int>, std::string,
                    int, int>(),
           py::keep_alive<1, 2>(), py::keep_alive<1, 3>(), py::arg("sampler"),
           py::arg("optimizer"), py::arg("batch_size"), py::arg("n_samples"),
           py::arg("niter_opt"), py::arg("rotations"), py::arg("sites"),
