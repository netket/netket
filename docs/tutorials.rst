...
.. container:: jumbotron jumbotron-fluid landing-page-box landing-page-box-logo
    ...
    .. rst-class:: h2
      ...
      Learn Netket by looking at some commented python notebooks
...
.. panels::
    ...
    :doc:`Using a group convolutional neural network to learn the ground-state of a symmetric spin model <tutorials/G-CNN\ Honeycomb>`
    ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
