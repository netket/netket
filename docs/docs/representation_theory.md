...
$$ \mathcal{P}_\alpha |\psi\rangle = \frac{d_\alpha}{|S|} \sum_{g\in S} \chi_\alpha(g)^* g |\psi\rangle $$
is the projection of the wave function $|\psi\rangle$ onto the part of the Hilbert space that transforms according to the irrep $\alpha$ of dimension $d_\alpha$.
