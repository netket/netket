...
If all went well, you should have at least version {{ netket_version }} installed. We recommend always starting new projects with the latest available version.
